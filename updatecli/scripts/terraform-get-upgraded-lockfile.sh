#!/bin/bash
# terraform-upgrade-providers.sh: This script upgrades the providers of the provided Terraform project and prints the resulting terraform lock file content to the stdout
